import 'package:settpay/pages/account/create/accountAdvanceOption.dart';
import 'package:settpay/pages/account/create/backupAccountPage.dart';
import 'package:settpay/pages/account/create/createAccountForm.dart';
    ...
    final next = await showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        ...
        return CupertinoAlertDialog(
          ...
          content: Column(
            children: <Widget>[
              Image.asset('assets/images/pageshot.png'),
              Container(
